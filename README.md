...
| 2026-09-06 | R8 | R5 三篇提取式自测(回顾位,盲出题+交错) | 回顾 | 🚧 进行中 |
| 2026-09-06 | R8 | [抗生素发现史与耐药性](docs/antibiotics-history.md)(医学的胜利与透支) | 知识研究 | 🚧 进行中 |
| 2026-09-06 | R8 | [历法改革史:时间的社会建构](docs/calendar-reform.md)(儒略→格里高利、消失的十几天) | 知识研究 | 🚧 进行中 |
