...
| 2026-09-06 | R9 | R6 三篇提取式自测(回顾位,锚定出题) | 回顾 | 🚧 进行中 |
| 2026-09-06 | R9 | [社会性昆虫的集体决策](docs/insect-collective-decision.md)(蜂巢民主、蚁群、无领袖协调) | 知识研究 | 🚧 进行中 |
| 2026-09-06 | R9 | [地震科学:预测为何失败](docs/earthquake-prediction.md)(概率 vs 预报、L'Aquila 审判) | 知识研究 | 🚧 进行中 |
